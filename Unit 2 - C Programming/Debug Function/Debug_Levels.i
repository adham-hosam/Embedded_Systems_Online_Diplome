...
void Can_Init(){
  ...
  if(1) { if( 3 > 1 ) printf("@Func: %s\t,File: %s ,Line\t: %d" , __func__ , "Debug_Levels.c" , 13); printf(">>\t"); printf("\n"); };

}

void Can_Send(){

  if(1) { if( 3 > 1 ) printf("@Func: %s\t,File: %s ,Line\t: %d" , __func__ , "Debug_Levels.c" , 19); printf(">>\t"); printf("\n"); };
}

int main(){

 if(1) { if( 1 > 1 ) printf("@Func: %s\t,File: %s ,Line\t: %d" , __func__ , "Debug_Levels.c" , 24); printf(">>\t"); printf("Enter main\n"); };
 Can_Init();
 if(1) { if( 3 > 1 ) printf("@Func: %s\t,File: %s ,Line\t: %d" , __func__ , "Debug_Levels.c" , 26); printf(">>\t"); printf("\n"); };
 Can_Send();
 if(1) { if( 1 > 1 ) printf("@Func: %s\t,File: %s ,Line\t: %d" , __func__ , "Debug_Levels.c" , 28); printf(">>\t"); printf("Exit main\n"); };
